...
const Hotel = () => {
  ...
  const handleMove = (direction) => {
    ...
    if(direction==="l"){
      ...
      newSlideNumber = (slideNumber+1)%5;
    }
        ...
        <div className="hotelContainer">
          ...
          <div className="hotelWrapper">
            ...
            <span className="hotelDistance">
              Amazing location! - {data.distance}m from center
            </span>
            <span className="hotelPriceHighlight">
              Book a stay above {data.cheapestPrice} to get free taxi for a day!
            </span>
